  ...
  factory: (require) => {
    ...
    function MarkdownView({ content }) {
      ...
      const flushList = () => {
        ...
        nodes.push(React.createElement('ul', { key: 'ul-' + nodes.length }, list.map((item, index) => React.createElement('li', { key: index }, item))))
        list = []
      }
